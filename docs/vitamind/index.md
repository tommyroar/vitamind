...
The [VitaminD web application](https://tommyroar.github.io/vitamind/) is a tool designed to predict when sufficient sun exposure for Vitamin D production will occur based on geographic location and sun data. It is built as a Single Page App (React) deployed via GitHub Pages.
