...
The deployment has been split into two independent tracks:
1.  **Vitamind SPA**: Deploys automatically on push to `main` via `.github/workflows/deploy-spa.yaml`.
2.  **Documentation**: Must be manually triggered via `.github/workflows/deploy-docs.yaml`.
